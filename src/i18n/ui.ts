...
export const ui = {
  de: {
    ...
    // Contact
    "contact.sub":
      "Stuntkoordinator · Kampfchoreograph\nAction-Darsteller · Artist · Zauberer",
    ...
    // Footer
    "footer.brand.text":
      "Stuntman, Kaskadeur, Artist und Schauspieler aus Dresden. Über 23 Jahre Erfahrung in Film, Fernsehen, Theater und Show — international.",
    "footer.col.nav": "Navigation",
    "footer.col.wissen": "Wissenswertes",
    "footer.col.legal": "Downloads & Rechtliches",
    "footer.copy":
      "© 2026 Ilian Simeonow · Stuntman & Artist · Dresden, Germany",
    ...
    // Meta descriptions
    "meta.home":
      "Ilian Simeonow — Stuntman, Kaskadeur, Artist und Schauspieler aus Dresden. 23+ Jahre Erfahrung in Film, Fernsehen und Theater. Jetzt buchen.",
    "meta.bio":
      "Biographie von Ilian Simeonow: diplomierter Artist der Staatlichen Ballettschule Berlin, Trampolin-Kaskadeur und internationaler Stuntman.",
    "meta.skills":
      "Alle Stunt- und Artistik-Fertigkeiten von Ilian Simeonow: Fechten, Highfall, Globe of Speed, Kampfchoreographie und mehr.",
    "meta.credits":
      "46+ Produktionen: Kinofilme, Opern, Open-Air-Theater und TV-Produktionen. Vollständige Credits von Ilian Simeonow.",
  },
  ...
  en: {
    ...
    // Footer
    "footer.brand.text":
      "Stuntman, stunt performer, artist and actor based in Dresden. 23+ years of experience in film, television, theatre and live shows — internationally.",
    "footer.col.nav": "Navigation",
    ...
    // Meta descriptions
    "meta.home":
      "Ilian Simeonow — stuntman, stunt performer, artist and actor from Dresden. 23+ years in film, TV and theatre. Available for bookings.",
    "meta.bio":
      "Biography of Ilian Simeonow: graduate of the State Ballet School Berlin, trampoline stunt performer and international stuntman.",
    "meta.skills":
      "Ilian Simeonow's full range of stunt and acrobatic skills: fencing, high falls, Globe of Speed, fight choreography and more.",
    "meta.credits":
      "46+ productions: feature films, opera, open-air theatre and TV. Full credits of Ilian Simeonow.",
  },
} as const;
